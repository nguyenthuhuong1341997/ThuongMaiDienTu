	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('public/Login/images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form method="POST" method="?mod=login&act=separation" class="login100-form validate-form" >
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Email bắt buộc">
						...
						<input  class="input100" type="email" name="email" placeholder="Nhập vào email">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Yêu cầu mật khẩu">
						<span class="label-input100">Mật khẩu</span>
						<input class="input100" type="password" name="password" placeholder="Nhập vào password">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
